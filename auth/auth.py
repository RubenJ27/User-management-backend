...
from schema.user__auth_schema import AuthUser, AuthUserInDB, TokenData  # Ajusta la ruta de importación

# Cargar las variables de entorno desde el archivo .env
load_dotenv()

# Configuración de la clave secreta y el algoritmo de cifrado
...
# Esquema OAuth2 para obtener el token de acceso
